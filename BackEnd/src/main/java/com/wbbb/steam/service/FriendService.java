...
public class FriendService {
    ...
    /** 获取好友列表 */
    public List<UserSimpleDto> getFriendList(Long userId) {
    ...
    /** 获取已发送的好友申请 */
    public List<UserSimpleDto> getSentFriendInvitations(Long userId) {
        return invitationRepository.getSentFriendInvitations(userId);
    }


    /** 获取未处理的好友申请 */
    public List<UserSimpleDto> getPendingFriendInvitations(Long userId) {
